...
with col_1:
    with st.container(border=True):
        ...
        user_pct = st.slider('Choose the percentage change in the material', value=0, min_value=-500, max_value=500)
        summer.change_affect(company_df, material_df, user_pct)
